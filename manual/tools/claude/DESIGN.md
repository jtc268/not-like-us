...
Anthropic also tells users to ask for a different aesthetic and warns against Inter, Roboto, system fonts, purple gradients, and predictable layouts. That advice is a floor. Design direction still has to come from the product.
